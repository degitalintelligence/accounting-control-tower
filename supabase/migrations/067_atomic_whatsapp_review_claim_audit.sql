...
BEGIN
  ...
  INSERT INTO acct_ctrl.audit_logs (organization_id, actor_id, action, entity_type, entity_id, new_value, metadata)
  VALUES (p_organization_id, p_claimed_by, 'wa_suggestion.claimed', 'action_suggestion', claimed.id,
    jsonb_build_object('review_state', claimed.review_state, 'claimed_by', claimed.claimed_by, 'claim_expires_at', claimed.claim_expires_at),
    jsonb_build_object('source_type', claimed.source_type, 'source_reference_id', claimed.source_reference_id));
