ALTER TABLE acct_ctrl.template_versions
  ADD COLUMN IF NOT EXISTS checklist_template_id UUID REFERENCES acct_ctrl.checklist_templates(id);

CREATE INDEX IF NOT EXISTS idx_template_versions_checklist_template
  ON acct_ctrl.template_versions(checklist_template_id);
