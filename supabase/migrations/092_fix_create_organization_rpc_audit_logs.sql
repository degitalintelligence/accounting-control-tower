-- Fix: create_organization_with_owner RPC failing due to missing 'metadata' column
-- in audit_logs insert, which is NOT NULL in some environments despite having a default.
-- Also ensures all system role insertions are explicit.
