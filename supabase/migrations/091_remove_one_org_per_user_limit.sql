-- Menghapus batasan satu organisasi per user agar pengguna bisa memiliki/membuat
-- lebih dari satu organisasi (multi-tenant ownership).
-- Batasan USER_ALREADY_HAS_ORGANIZATION sebelumnya diperkenalkan di migrasi 089 secara tidak sengaja.
...
BEGIN
  ...
  -- LIMIT DIHAPUS: v_user_id boleh memiliki banyak organisasi.
  -- Unique constraint pada organizations(slug) tetap menjaga integritas slug global.
