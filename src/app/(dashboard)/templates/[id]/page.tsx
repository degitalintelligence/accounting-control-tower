  ...
  return (
    <main className="page-canvas text-slate-900"><div className="mx-auto w-full max-w-6xl space-y-6">
        ...
        <Tabs defaultValue="detail">
          <TabsList className={`w-full justify-start overflow-x-auto sm:grid ${has("sop.manage") ? "sm:grid-cols-4" : "sm:grid-cols-2"}`}>
            ...
            {has("sop.manage") && <TabsTrigger value="steps">Langkah</TabsTrigger>}
            {has("sop.manage") && <TabsTrigger value="recurrence">Pengulangan</TabsTrigger>}
          </TabsList>
